  ...
  render () {
    ...
    const secretAreaLink = (
      <Link to="/account/secret-area">
        <FormattedMessage {...accountSuperSecretArea} />
      </Link>)
    ...
    return (
      <div>
        ...
        <div className="content">
          <p>
            <FormattedMessage {...accountIntro} />
            <br/>
            <FormattedMessage {...accountSteps}
