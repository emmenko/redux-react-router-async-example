...
const intro = defineMessage({
  id: 'home.intro',
  description: 'Introductive message about the website',
  defaultMessage: 'This website is a boilerplate example showcasing mostly ' +
    '{linkRedux} and {linkRouter}.'
})

const intro2 = defineMessage({
  id: 'home.intro2',
...
export default class Home extends React.Component {
  ...
  render () {
    ...
    const linkIssues = (<a
      ...
      target="_blank"><FormattedMessage {...dropIssue} /></a>)
    return (
      <div>
        ...
        <div className="content">
          <p>
            <FormattedMessage {...intro} values={{ linkRedux, linkRouter }} />
          </p>
          <p>
            <FormattedMessage {...intro2} values={{ br: (<br/>) }} />
          </p>
          <p>
            <FormattedMessage {...intro3} values={{ linkIssues }} />
          </p>
        </div>
      </div>
    )
